...
def main():
    ...
    args = p.getArgs()
    optionalArgsObject = p.getOptionalArgsObject()
    print "optionalArgsObject = ",optionalArgsObject
    creator = Configurator(args, optionalArgsObject, "$HOME/.lsst/condor-info.py")
